                        ...
                        <div class="col-md-11">
                                ...
                                <div class="col-md-12 border d-flex"style="margin-top: -25px;font-size: 18px">
                                    ...
                                    <div class="col-md-6 thong-tin-gia-tien"style="border-left: 1px dashed #D1D3E2">
                                        ...
                                        <div class="d-flex  mt-3 ml-3">
                                            ...
                                            <p class="text-muted mb-0"style="position: absolute;left: 20vh">: <span class="fw-bold me-4" style=" color: black;">${sessionScope.PRICE} VNĐ</span></p>
                                        </div>
                                        <div class="d-flex  mt-3 ml-3 ">
                                        ...
                                        <div class="d-flex mt-3 ml-3 mb-4">
                                            ...
                                            <p class="text-muted mb-0" style="position: absolute;left: 20vh;">: <span class="fw-bold me-4" style=" color: black;">${sessionScope.PRICE * 0.1} VNĐ</span></p>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between card-footer border-0 px-4 py-5">
                                    <div class="d-flex flex-column align-items-start">
                                        ...
                                        <c:if test="${sessionScope.LOGIN_USER.accountBalance >= sessionScope.PRICE}"> 
                                            ...
                                            <a href="${pageContext.request.contextPath}/book?action=paypal&orderID=${sessionScope.ORDER.orderID}" style="width: 260px; margin-bottom: 10px; background-color: #dc008a;
                                               color: white; padding: 12px; border-radius:10px;">
                                                <img width="30px;" src="https://upload.wikimedia.org/wikipedia/vi/f/fe/MoMo_Logo.png" alt="alt"/> 
                                                Pay via Paypal 
                                            </a>
                                            ...
                                            <input type="hidden" value="${sessionScope.PRICE}" name="totalPrice">
                                        </form>

                                    </div>
                                    <h5 class="text-uppercase mb-0">Total
                                        paid: <span class="h2 mb-0 ms-2">${sessionScope.PRICE + (sessionScope.PRICE * 0.1)} VNĐ</span></h5>
                            ...
                            <!--                            <div class="card-footer border-0 px-4 py-5"
                                                            ...
                                                            <h5 class="d-flex align-items-center justify-content-end text-white text-uppercase mb-0">Total
                                                                ...
                                                                paid: <span class="h2 mb-0 ms-2">${sessionScope.PRICE + (sessionScope.PRICE * 0.1)} VND</span></h5>
                                                        </div>-->
