                                ...
                                <div class="card-body p-4">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 text-center d-flex justify-content-center align-items-center">
                                                    <p class="text-muted mb-0">Sài Gòn - Đà Lạt</p>
                                                </div>
                                                <div class="col-md-2 text-center d-flex justify-content-center align-items-center">
                                                    <p class="text-muted mb-0 small">8:00</p>
                                                </div>
                                                <div class="col-md-2 text-center d-flex justify-content-center align-items-center">
                                                    <p class="text-muted mb-0 small">10/10/2022</p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between card-footer border-0 px-4 py-5">
                                        <div class="d-flex flex-column align-items-start">
                                            <!--//--> 
                                            <button style="width: 200px; margin-bottom: 10px; background-color: #dc008a;
                                            ...
                                            <button style="width: 200px; margin-bottom: 10px; border-radius: 10px; padding: 5px; background-color: white">
