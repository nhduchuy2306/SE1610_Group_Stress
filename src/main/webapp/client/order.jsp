                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class=" shadow-0 border mb-4 col-md-12 d-flex thong-tin-chuyen-xe">
                                        ...
                                        <div class="col-md-8 chi-tiet-trip">
                                            <h3 style="text-decoration: underline;margin-bottom: 10px">Trip: <span>${requestScope.TRIP.tripName}</span></h3>
                                        <p style="font-size: 18px">Driver: ${requestScope.TRIP.driver.driverName} - Phone: ${requestScope.TRIP.driver.phoneNumber}</p>
                                        <div class="from-date-to d-flex mt-3" style="font-size: 17px" >
                                            <p class="from" style="margin-left: 20px">From:</p>
                                            <p class="date" style="position: absolute; left: 255px">Start day: <span style="color: #970899">${requestScope.TRIP.startDateTime}</span> </p>
                                        ...
                                        <div class="from-date-to-detail d-flex" style="font-size: 17px">
                                            <p class="from" style="color: #fa4e05;font-size: 18px;font-weight: bold">${requestScope.TRIP.route.startLocation.locationName}</p>
                                            <p class="date"style="position: absolute; left: 255px">Start Time:<span style="color: #970899;margin-left: 4px">${requestScope.TRIP.startTime}</span></p>
                                            <p class="to"style="position: absolute; right: 20px;color:#fa4e05;font-size: 18px;font-weight: bold">${requestScope.TRIP.route.endLocation.locationName}</p>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12 border d-flex"style="margin-top: -25px;font-size: 18px">
                                    ...
                                    <div class="col-md-6 thong-tin-gia-tien"style="border-left: 1px dashed #D1D3E2">
                                        ...
                                        <div class="d-flex  mt-3 ml-3">
                                            ...
                                            <p class="text-muted mb-0"style="max-width: 90%">: <span class="fw-bold me-4" style=" color: black;">${requestScope.SEAT_LIST}</span></p>
                                        </div>
                                        <div class="d-flex  mt-3 ml-3">
                                            <p class="text-muted mb-0">Price Before Tax</p>
                                            <p class="text-muted mb-0"style="position: absolute;left: 20vh">: <span class="fw-bold me-4" style=" color: black;">${requestScope.PRICE} VNĐ</span></p>
                                        </div>
                                        <div class="d-flex  mt-3 ml-3 ">
                                            <p class="text-muted mb-0">Invoice Date</p>
                                            <p class="text-muted mb-0"style="position: absolute;left: 20vh">: <span class="fw-bold me-4" style=" color: black;">${requestScope.ORDER.createDate}</span></p>
                                        </div>
                                        <div class="d-flex  mt-3 ml-3">
                                            <p class="text-muted mb-0">Ticket Quantity </p>
                                            <p class="text-muted mb-0"style="position: absolute;left: 20vh">: <span class="fw-bold me-4" style=" color: black;">${requestScope.QUANTITY}</span></p>
                                        </div>
                                        <div class="d-flex mt-3 ml-3 mb-4">
                                            <p class="text-muted mb-0">Taxes </p>
                                            <p class="text-muted mb-0" style="position: absolute;left: 20vh;">: <span class="fw-bold me-4" style=" color: black;">${requestScope.PRICE * 0.1} VNĐ</span></p>
                                        </div>
                                        <div class="d-flex mt-3 ml-3 mb-4">
                                            <p class="text-muted mb-0">Using coupon </p>
                                            <select name="coupons" id="selectCoupon" class="coupon" onchange="changeFunc();">
                                                <option value="" disabled selected>Choose Coupon</option>
                                    ...
                                    <div class="d-flex flex-column align-items-start">
                                        ...
                                        <c:if test="${sessionScope.LOGIN_USER.accountBalance >= requestScope.PRICE}"> 
                                            <form action="${pageContext.request.contextPath}/book" method="POST">
                                                ...
                                                <input type="hidden" value="${requestScope.PRICE}" name="totalPrice" id="totalPrice">
                                            </form>
                                        </c:if>
                                    </div>
                                    <input type="hidden" value="${requestScope.PRICE + (requestScope.PRICE * 0.1)}" id="default-totalPrice">
                                    <h5 class="text-uppercase mb-0">Total
                                        paid: <span class="h2 mb-0 ms-2" id="totalPrice-span">${requestScope.PRICE + (requestScope.PRICE * 0.1)} VNĐ</span></h5>
